class SalesFigure < ApplicationRecord
  ...
  def self.zipcode_data
    sql = <<-SQL
      SELECT sales.id, sales.zipcode, sales.jurisdiction, sales.total_sales, sales.median_value, z.gid, z.statefp10, z.zcta5ce10, z.geoid10, z.classfp10, z.mtfcc10, z.funcstat10, ST_AsGeoJSON(z.geom)::JSON AS geometry
